...
public class Employee implements Person {
	...
	public String toString() {
		return String.format("%s, %25s %s", id, this.firstname+" "+this.lastname+",", salary);
	}
	...
	public static SalaryRange sortRange(Employee e) {
		...
		else if (bdSalary.compareTo(BigDecimal.valueOf(40000))<0) return SalaryRange.from25to40;
		else if (bdSalary.compareTo(BigDecimal.valueOf(70000))<0) return SalaryRange.from40to70;
